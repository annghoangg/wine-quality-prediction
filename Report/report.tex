...
\begin{enumerate}
    \item \textbf{Ratio Features:} Acid ratio, sulfur ratio, and alcohol-sugar ratio capture the relative balance between complementary chemical properties.
    \item \textbf{Interaction Features:} Density-alcohol interaction and sulphates-alcohol interaction capture multiplicative relationships.
    \item \textbf{Polynomial Features:} Squared terms for alcohol and volatile acidity capture non-linear effects.
    \item \textbf{Logarithmic Features:} Log-transformed volatile acidity, residual sugar, and chlorides reduce skewness.
    \item \textbf{Chemical Balance Index:} A composite feature combining alcohol, volatile acidity, sulphates, citric acid, and chlorides with domain-informed weights:
\end{enumerate}
...
where VA is volatile acidity, CA is citric acid, and $\epsilon = 10^{-8}$ prevents division by zero.
